...
abstract class Template {
	...
	public static function e_isset( &$check, $alternate = false ){
		echo ( !empty( $check ) ) ? $check : $alternate; //xss ok
	}
	...
	public static function wrap_isset( &$check, $opentag = '<p>', $closingtag = '</p>' ) {
		if ( !empty( $check ) )
			echo $opentag . $check . $closingtag; //xss ok
		else
			return; 
	}
	...
	public static function link_wrap_isset( &$check, $insidetext = '', $opentag = '', $closingtag = '', $classes = '', $id = '' ) {
		if ( !empty( $check ) )
			echo $opentag . '<a href="' . $check . '" id="' . $id . '" class="' . $classes . '">' . $insidetext . '</a>' . $closingtag; //xss ok
		else
			return; 
	}
	...
	public static function e_content( &$content, $opentag = '', $closingtag = '' ) {
		if ( !empty( $content ) )
			echo $opentag . apply_filters( 'the_content', $content ) . $closingtag; //xss ok
		else
			return;
	}
